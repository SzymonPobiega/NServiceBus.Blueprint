namespace AcceptanceTests
{
    ...
    [TestFixture]
    public class When_using_diamond_topology : NServiceBusAcceptanceTest
    {
        static string routingFilePath = $"{nameof(When_using_diamond_topology)}.xml";
        ...
        public async Task Should_deliver_the_reply()
        {
            ...
            var result = await Scenario.Define<Context>()
                ...
                {
                    cfg.AddInterface<TestTransport>("Green", t => t.BrokerAlpha()).InMemorySubscriptions();
                    cfg.AddInterface<TestTransport>("Yellow", t => t.BrokerCharlie()).InMemorySubscriptions();
